...
//        
//        
//        double grossPay = ((hourlyRate*hoursWorked)+(hourlyRate*hoursOvertime)+holidayPay+bonuses);
//        
...
//    }
    ...
    private void initComponents() {
        ...
        btnGeneratePayslip.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        ...
        jPanel3.add(btnGeneratePayslip, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 177, 30));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 710, 670));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to save data?", "Save data", JOptionPane.YES_NO_OPTION);
        if(x == 0){
            try{
                ...
                pst.execute();
                JOptionPane.showMessageDialog(null, "Payroll information has been saved");
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        // for description
                        String desc = "Payroll saved. Emp Id: "+tfEmpId.getText();
    ...
    private void btnUpdatePayrollActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePayrollActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure update payroll information?", "Update payroll", JOptionPane.YES_NO_OPTION);
        if(x == 0){
            try{
                ...
                pst = con.prepareStatement(query);
                pst.execute();
                JOptionPane.showMessageDialog(null, "Payoll information has been updated successfully!");
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        // for description
                        String desc = "Payroll updated. Emp Id: "+tfEmpId.getText();
    ...
    private void btnDeletePayrollActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletePayrollActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to delete data?", "Delete payroll", JOptionPane.YES_NO_OPTION);
        if(x == 0) {
            try{
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        // for description
                        String desc = "Payroll deleted. Emp Id: "+tfEmpId.getText();
                ...
                JOptionPane.showMessageDialog(null, "Payroll information has been deleted.");
    ...
    private void btnGeneratePayslipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneratePayslipActionPerformed
        ...
        try {
            ...
            if(rs.next()){
                // Get admin name in database and store in a variable
                String adminName = rs.getString("name");
                ...
                if (dialogResult == JFileChooser.APPROVE_OPTION){
                    ...
                    Text text4 = new Text(empName).setFont(boldFont).setFontSize(13);
                    ...
                    try{
                        ...
                        // for description
                        String desc = "Payroll generated. Emp Id: "+tfEmpId.getText();
