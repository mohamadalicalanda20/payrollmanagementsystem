...
public class EmployeeInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("As Admin:");
        jPanel3.add(jLabel16);
        jLabel16.setBounds(850, 30, 58, 30);
        jPanel3.add(lblAdminId);
        lblAdminId.setBounds(920, 30, 40, 30);
        ...
        jPanel3.add(btnHome);
        btnHome.setBounds(80, 30, 73, 30);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel1.setText("Search:");
        jPanel3.add(jLabel1);
        jLabel1.setBounds(200, 30, 49, 30);
        ...
        tfSearch.setBounds(270, 30, 260, 30);
        ...
        jPanel8.add(lblImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 210, 175));
        ...
        jPanel9.add(btnAttach, new org.netbeans.lib.awtextra.AbsoluteConstraints(308, 172, -1, -1));
        jPanel9.add(tfBasicSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 252, 30));

        jLabel13.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        jLabel13.setText("Job title:");
        jPanel9.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, 30));
        jPanel9.add(tfJobtitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 252, 30));

        jLabel14.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        jLabel14.setText("Status:");
        jPanel9.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, -1, 30));
        jPanel9.add(tfStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 252, 30));

        jLabel15.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        jLabel15.setText("Date hired:");
        jPanel9.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, -1, 30));
        ...
        jPanel9.add(btnAddrecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 429, 130, 38));
        ...
        jPanel9.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 489, 130, 38));
        ...
        jPanel9.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 429, 130, 38));
        ...
        jPanel9.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 489, 130, 38));

        dcDateHired.setPreferredSize(new java.awt.Dimension(64, 24));
        jPanel9.add(dcDateHired, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 360, 252, 30));

        jLabel17.setFont(new java.awt.Font("Century Gothic", 0, 13)); // NOI18N
        jLabel17.setText("Basic salary:");
        jPanel9.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, -1, 30));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to delete data?", "Delete data", JOptionPane.YES_NO_OPTION);
        if(x == 0){
            try{
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        // for description
                        String desc = "Deleted information. Emp Id: "+tfEmpId.getText();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to update data?", "Update data", JOptionPane.YES_NO_OPTION);
        if(x == 0){
            try{
                ...
                + " gender='"+gen+"', email='"+email+"', personal_phone='"+personalPhone+"', home_phone='"+homePhone+"', address='"+address+"', postalcode='"+postalcode+"',"
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        // for description
                        String desc = "Updated information. Emp Id: "+idEmp;
    ...
    private void btnAddrecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddrecordActionPerformed
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to add data?", "Add data", JOptionPane.YES_NO_OPTION);
        if(x == 0){
            try{
                ...
                pst.setString(4, ((JTextField)dcDob.getDateEditor().getUiComponent()).getText());
                pst.setString(5, gender);
                pst.setString(6, tfEmail.getText());
                pst.setString(7, tfPersonalPhone.getText());
                pst.setString(8, tfHomePhone.getText());
                pst.setString(9, tfAddress.getText());
                pst.setString(10, tfPostalcode.getText());
                pst.setString(11, tfJobtitle.getText());
                pst.setString(12, tfStatus.getText());
                pst.setString(13, tfBasicSalary.getText());
                pst.setString(14, ((JTextField)dcDateHired.getDateEditor().getUiComponent()).getText());
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        try{
                            ...
                            if(rs.next()){
                                // Retrieved employee id after saving
                                String empId = rs.getString("id");

                                // for description
                                String desc = "Added new information. Emp Id: "+empId;
